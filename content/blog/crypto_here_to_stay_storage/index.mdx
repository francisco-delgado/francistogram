...
This is the second post in a short series about how, where, and why to store your virutal assets on a wallet that you control
...
It's somewhat of a misnomer and a common misconception is that, unlike wallets for your dollar, a crypto wallet doesn't store your assets

Assets are not stored in any centralized place and instead on the blockchain that's stored on everyone's computer who has it downloaded

That's the beauty of decentralization, there's no single point of failure

Wallets provide a framework for you to interface with the blockchain network and access your assets there
...
Upon creation you'll also get a **private key** which is separate set of random numbers and letters
...
These most common kind of wallets out there
...
I'd recommend doing some of your own searching through coin specific subreddits to find community defined best practices on how and where to store

## Hardware Wallets

This is crypto's version of keeping cash under the mattress

It's a physical device that has no connection to the outside (no wifi) world except through a phone or a computer
...
You end up paying \$60 more for the wireless convenience which I personally think has been worth it
