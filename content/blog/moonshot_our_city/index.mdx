...
date: "2020-07-10"
description: "I'd ask for luck, but we've already created our own"
---
...
Those who don't will eventually block, mute or unfollow me or Instagram's algorithm will move my stories to the end of their recommendations
...
The transparency shows that I'm open to constructive feedback while willing to stand up for what I believe in
...
That friend, if they come to my profile, will only be able to judge my "worth" on the stories of that day and or a curated grid
...
This only works with friends that you trust
...
Ultimately, we will help the listeners see the future we see
...
My connections, my skill set, and my resources
...
She's created opportunities for many. The values she was founded on have allowed those with motivation, self-confidence, and a unique taste for risk to uproot their lives and join her for the chance of lifting themselves, their families, and their community back home out of the system keeping them down
...
My intention of displaying the data is to reframe the current fight

Instead of having the current delta between the "Haves" and the "Have Nots" trigger emotions of jealousy and anger, we should let our continued progress inspire the world to work even harder together
...
My entire life I've always been the center of my friend groups. This is true of high school, college, and work, but most evidently in the "real" world - the life I'm living now that I've quit my job on July 3rd, 2020
