...
#### This is as much your community as it is mine
...
Rather, my suggestion is that instead of having the current delta in difference between the "Haves" and the "Have Nots" trigger emotions of jealousy and instead let our continued progress inspire the world to work even harder - together
...
We've forgetten our family, friends, and, particularly, the community in which we exist who will love us unconditionally and catch us if we fall

I want to create this city as a safe haven for those in our community

When this house of card collapses I want to have the infrastructure built so that our community has somewhere to escape to

A landing pad for safe landing and a launch pad for future success

**Colonizer: a plant or animal that establishes itself in an area**

![Colonizer Ecology](./colonizer_ecology.png)

Words matter, pick the right one.
...
Without openly considering feedback, both positive and negative, from those a policy affects the result will always be imperfect
...
As there are no get rich quick schemes, there are no build trust quickly schemes
...
> Would you like to join our city?

I offer the world

Their decision?

That's for them to make - not me
